...
5. 版权来源、历史开发证据、CLA 签署导出和法律意见由私有合规记录保存，不进入本仓库；公开仓库只保留已激活协议正文和可复用流程说明。

本仓库已经包含标准 AGPL 原文、社区治理文件、依赖许可门禁和已激活的个人 CLA。个人 CLA 只覆盖贡献者有权许可的个人贡献；公司、学校或其他组织所有的材料仍需单独的权利确认或 Entity CLA。
...
这些资料支持任务、版本和安全报告的工程组织方式；许可证、CLA、商标和商业双授权仍应在重大变更时取得适用法域的专业意见。
