...
当前 [`CLA.md`](./CLA.md) 是准备启用的个人 CLA 候选文本，计划被授权方为 **郝春霖 (Hao Chunlin)**，但仍为 `NOT ACTIVE`。在联系邮箱、准据法、公共仓库、CLA Assistant 和分支必需检查完成复核与测试前，不得合并外部版权性贡献。仅在 PR 文本中勾选一句话、评论或发送邮件，不能替代有效且可追踪的签署记录。
