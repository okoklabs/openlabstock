...
const required = [
  ...
  'scripts/handoff.mjs', 'scripts/instance-agent.mjs', 'scripts/reset-owner-password.mjs', 'deploy/openlabstock.sh', 'package.json', 'LICENSE', 'NOTICE', 'THIRD_PARTY_NOTICES.md',
];
